...
describe 'postfix::service' do
  ...
  describe 'with defaults' do
    ...
    it { is_expected.not_to contain_file('/var/spool/postfix/etc/resolv.conf') }
    it { is_expected.not_to contain_file('/var/spool/postfix/etc/hosts') }
    it { is_expected.not_to contain_file('/var/spool/postfix/etc/services') }
  end
